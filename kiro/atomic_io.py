...
def write_text_atomic(path: Path, content: str, default_mode: int = 0o600) -> bool:
    ...
    try:
        ...
        mode = stat.S_IMODE(target_path.stat().st_mode) if target_path.exists() else default_mode
