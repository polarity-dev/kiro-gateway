...
> truth). Unless the user explicitly names another path, use the current
> repository directory automatically. Keep setup, gateway startup, and
> verification in that same working directory. Prefer `Monitor` over
